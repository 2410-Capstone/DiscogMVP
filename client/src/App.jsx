    ...
    const fetchAllItems = async () => {
      try {
        const res = await fetch(
          `${import.meta.env.VITE_BACKEND_URL}/api/products?limit=999`
        );
    ...
    <>
      ...
      <div className="page-content">
        <Routes>
          ...
          <Route
            path="/search"
            element={<FullSearchResults allItems={allItems} />}
          />
          ...
          <Route
            path="/wishlists"
            element={
              isAuthenticated ? <WishlistsPage /> : <Navigate to="/login" />
            }
          />
          <Route
            path="/wishlists/new"
            element={
              isAuthenticated ? <CreateWishlist /> : <Navigate to="/login" />
            }
          />
          <Route
            path="/wishlists/:id"
